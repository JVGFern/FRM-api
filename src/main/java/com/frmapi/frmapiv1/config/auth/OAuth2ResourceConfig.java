...
import  com.frmapi.frmapiv1.config.CorsConfigFilter;
...
import static  com.frmapi.frmapiv1.config.auth.EPermissao.ADMIN;
import static  com.frmapi.frmapiv1.config.auth.EPermissao.USER;

@Configuration
@EnableResourceServer
public class OAuth2ResourceConfig extends ResourceServerConfigurerAdapter {

    @Value("${app-config.oauth-clients.frm-api.client}")
    private String oauthClient;
    @Value("${app-config.oauth-clients.frm-api.secret}")
    private String oauthClientSecret;
    @Value("${app-config.services.frm-api.url}")
